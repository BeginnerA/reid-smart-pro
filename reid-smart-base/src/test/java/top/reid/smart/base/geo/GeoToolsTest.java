package top.reid.smart.base.geo;
...
public class GeoToolsTest {
    ...
    @Test
    public void wktToFeatureCollection() {
        for (String s : wktStr) {
    ...
    public void readSHP() throws Exception {
        Map<String, Object> stringListMap = GeoTools.readShp(new File("E:\\信飞科技\\项目\\矿产资源规划\\530112西山区矿产资源规划数据库\\ArcGIS\\Shape\\D1_530112_E_2020_GJGHKQ.shp"));
